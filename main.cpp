...
int main(){
  ...
  Node p1(Point(40.920404,39.19209));
  Node p2(Point(40.246859,35.51488));
  Node p3(Point(46.867656,33.583913));
  Node p4(Point(50.523429,29.461285));
  Node p5(Point(37.4816667,-83.3252778));
  Node p6(Point(11.166667,106.316667));
  Node p7(Point(49.377695,37.621363));
  Node p8(Point(60.433333,28.45));
